...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImVec2 pos = window->DC.CursorPos + ImVec2(0, 4);
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (is_multiline)
    {
        ...
        draw_window->DC.NavLayersActiveMaskNext |= draw_window->DC.NavLayerCurrentMask; // This is to ensure that EndChild() will display a navigation highlight so we can "enter" into it.
...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    PushStyleVar(ImGuiStyleVar_WindowPadding, { 5,5 });
    BeginGroup();
    PushID(label);
    ...
    if (!(flags & ImGuiColorEditFlags_NoSmallPreview))
    {
        ...
        if (ColorButton("##ColorButton", col_v4, flags, ImVec2(18, 13)))
        {
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    if (hovered || selected)
    {
        ...
        // gradient
        window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max, GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.03f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.03f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.10f)), GetColorU32(ImVec4(0.0f, 0.0f, 0.0f, 0.10f)));
