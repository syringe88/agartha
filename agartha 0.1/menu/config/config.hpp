...
namespace c {
	...
	namespace movement {
		...
		// Advanced edgebug settings (from DNA-SOURCECODE-main integration)
		inline int advanced_radius = 6;
		inline bool enable_angle_limit = false;
	}

	// Movement helper settings for advanced edgebug detection
	namespace movehelp {
		inline float edgebug_scan = 0.4f;
		inline bool advanced_edgebug = false;
	}
