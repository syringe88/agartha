...
public:
	...
	void text_glow(int x, int y, int size, ImFont* font, const char* text, bool centered, const color_t& glow_color, int flags);
	void text_shadow_glow(int x, int y, int size, ImFont* font, const char* text, bool centered, const color_t& text_color, const color_t& shadow_color, bool is_detected, int flags);
...
namespace fonts {
	...
	inline ImFont* clarity_watermark;
	inline ImFont* esp_damage_font;
	inline ImFont* menutab_icons;
	inline ImFont* watermark_icons;
	inline ImFont* menu_font_thin;
	inline ImFont* menu_font_bold;
	inline ImFont* indicator_font;
	inline ImFont* indicator_font_tahoma;
	inline ImFont* sub_indicator_font;
	inline ImFont* spec_font;
	inline ImFont* main_spec_font;
	inline ImFont* second_spec_font;
	...
	inline ImFont* menu_icons;
	inline ImFont* sub_feature_icon;
	inline ImFont* dna_font;
	inline ImFont* dna_icon;
	inline ImFont* dna_icon_rain;
	inline ImFont* points_font;
	inline ImFont* points_big_font;
	inline ImFont* logo;
	inline ImFont* logo_watermark;
