...
{
    static auto pThis = *reinterpret_cast<void**>(find_pattern("client.dll", "B9 ? ? ? ? 68 ? ? ? ? E8 ? ? ? ? 89") + 0x1);

    using find_hud_element_fn = std::uintptr_t* (__thiscall*)(void*, const char*);
    static auto find_hud_element = reinterpret_cast<find_hud_element_fn>(find_pattern("client.dll", "55 8B EC 53 8B 5D 08 56 57 8B F9 33 F6 39 77 28"));
